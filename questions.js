questions =  [
    ...
    {"id": 2, "question": "The government should not set a minimum wage.", "effects": {"right": 1}},
    {"id": 3, "question": "It is \"human nature\" to be greedy.", "effects": {"right": 1}},
    {"id": 4, "question": "\"Exploitation\" in developed countries is an outdated term, as the struggles of 1800s capitalism don't exist anymore.", "effects": {"right": 1}},
    {"id": 5, "question": "Communism is an ideal that can never work in practice.", "effects": {"right": 1}},
    {"id": 6, "question": "Alternative forms of taxation, such as a land tax, sales tax or complete tax abolition are preferable to having an income tax.", "effects": {"right": 1}},
    {"id": 7, "question": "The harder you work, the more you progress up the social ladder.", "effects": {"right": 1}},
    {"id": 8, "question": "Organisations and corporations cannot be trusted and need to be regulated by the government or community.", "effects": {"right": -1}},
    {"id": 9, "question": "A government that provides for everyone is an inherently good idea.", "effects": {"right": -1}},
    {"id": 10, "question": "An economy based on private property is not the best way to run a society.", "effects": {"right": -1}},
    {"id": 11, "question": "Land should not be a commodity to be bought and sold.", "effects": {"right": -1}},
    {"id": 12, "question": "All industry and the bank should be nationalised or held in collective ownership.", "effects": {"right": -1}},
    ...
    {"id": 27, "question": "Most services currently provided by the government should be provided by the community or the free market.", "effects": {"auth": -1}},
    ...
    {"id": 39, "question": "LGBTQ+ individuals should not be able to adopt children.", "effects": {"prog": -1}},
